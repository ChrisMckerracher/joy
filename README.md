...
- **[joy-browser](packages/joy-browser)** — an optional extension for Chrome and Firefox that ties a session to your own browser: chat with it from any page, and let it run scripts there, over the relay.
